...
\textbf{How test will be performed:} \sout{An automated test case will check the size of each image to ensure it matches the size specified in the search request.}
\textcolor{red}{Performed automatically using pytest.}
