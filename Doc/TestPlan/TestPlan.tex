...
\textbf{Initial State:} Linux machine has an empty Images folder at google-images-downloader/src/Images

\textbf{Input:} The command 'python3 Main.py -k "McMaster"' is provided through the command line

\textbf{Output:} There exists a folder at google-images-downloader/src/Images/McMaster that contains
all images related to McMaster

\textbf{How test will be performed:} The tester will follow the input steps above and check to ensure
...
\textbf{Input:} The command 'python3 Main.py -k "homestuck"' is provided through the command line
