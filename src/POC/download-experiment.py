...
def main():
    ...
    # image_html = tree.xpath('/html/head/meta[1]')
    print(tree.find('html/head/meta'))
    print(tree.values())
    # image_html = tree.getroot()
    # image_html = tree.xpath('/html/head/title/text()')
    # print(type(image_html))
    # image_html = tree.xpath('/html/head/meta[1]@content')
